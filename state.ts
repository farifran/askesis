...
export const PREDEFINED_HABITS: PredefinedHabit[] = [
    ...
    { nameKey: 'predefinedHabitMeditateName', subtitleKey: 'predefinedHabitMeditateSubtitle', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f1c40f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 20.2c.4.2.8.2 1.2.1 1.1-.4 1.8-1.5 1.5-2.6L10 12l.9-2.2c.3-1.1-.4-2.2-1.5-2.6-.4-.1-.8-.1-1.2 0C7 7.5 6.3 8.6 6.6 9.7l.9 3.1-.9 2.2c-.3 1.1.4 2.2 1.5 2.6z"></path><path d="M16 20.2c-.4.2-.8.2-1.2.1-1.1-.4-1.8-1.5-1.5-2.6L14 12l-.9-2.2c-.3-1.1.4-2.2-1.5-2.6.4-.1.8-.1 1.2 0 1.1.4 1.8 1.5 1.5 2.6l-.9 3.1.9 2.2c.3 1.1-.4 2.2-1.5 2.6z"></path></svg>', color: '#f1c40f', times: ['Manhã'], goal: { type: 'minutes', total: 10, unitKey: 'unitMin' }, frequency: { type: 'daily', interval: 1 } },
    ...
    { nameKey: 'predefinedHabitWalkName', subtitleKey: 'predefinedHabitWalkSubtitle', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#27ae60" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 3l-3 3 3 3"></path><path d="M7 14l3-3 4 4 3-3"></path><circle cx="12" cy="12" r="10"></circle></svg>', color: '#27ae60', times: ['Tarde'], goal: { type: 'minutes', total: 20, unitKey: 'unitMin' }, frequency: { type: 'daily', interval: 1 } },
    ...
    { nameKey: 'predefinedHabitCookHealthyName', subtitleKey: 'predefinedHabitCookHealthySubtitle', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#27ae60" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 20h10"></path><path d="M12 4v16"></path><path d="M10 4c-2.5 1.5-4 4-4 7"></path><path d="M14 4c2.5 1.5 4 4 4 7"></path></svg>', color: '#27ae60', times: ['Noite'], goal: { type: 'check', unitKey: 'unitCheck' }, frequency: { type: 'daily', interval: 1 } },
    ...
    { nameKey: 'predefinedHabitYogaName', subtitleKey: 'predefinedHabitYogaSubtitle', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9b59b6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 20.2c.4.2.8.2 1.2.1 1.1-.4 1.8-1.5 1.5-2.6L10 12l.9-2.2c.3-1.1-.4-2.2-1.5-2.6-.4-.1-.8-.1-1.2 0C7 7.5 6.3 8.6 6.6 9.7l.9 3.1-.9 2.2c-.3 1.1.4 2.2 1.5 2.6z"></path><path d="M16 20.2c-.4.2-.8.2-1.2.1-1.1-.4-1.8-1.5-1.5-2.6L14 12l-.9-2.2c-.3-1.1.4-2.2-1.5-2.6.4-.1.8-.1 1.2 0 1.1.4 1.8 1.5 1.5 2.6l-.9 3.1.9 2.2c.3 1.1-.4 2.2-1.5 2.6z"></path></svg>', color: '#9b59b6', times: ['Manhã'], goal: { type: 'minutes', total: 15, unitKey: 'unitMin' }, frequency: { type: 'daily', interval: 1 } },
