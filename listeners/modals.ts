...
import { t, setLanguage, formatList, compareStrings } from '../i18n';
    ...
    if (!navigator.onLine) {
        try {
            ...
            const offlineQuotes = STOIC_QUOTES.filter(q => 
                // FIX: Access tags through the metadata property.
            ...
            // FIX: Access localized text from the original_text property.
