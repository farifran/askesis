...
const _onPointerUp = (e: PointerEvent) => {
    ...
    if (DragMachine.isValidDrop && DragMachine.targetZone && DragMachine.sourceId && DragMachine.sourceTime) {
        ...
        // Marcar como sucesso para manter o cartão invisível até o próximo render.
        // Isso evita o glitch visual de "reaparecer na origem" antes de "aparecer no destino".
        dropSuccess = true;
    }
