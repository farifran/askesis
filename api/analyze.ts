...
// MODEL UPDATE: Switched to Gemini 2.0 Flash Lite (Preview).
// This model is optimized for cost/latency and typically has better availability for free tier than the main Flash model.
