...
export async function performAIAnalysis(type: 'monthly' | 'quarterly' | 'historical') {
    ...
    try {
        ...
        const workerPayload = { analysisType: type, habits: state.habits, dailyData: state.dailyData, archives: state.archives, monthlyLogsSerialized: logsSerialized, languageName: getAiLanguageName(), translations: trans, todayISO };
