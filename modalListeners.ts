...
import { ui } from './ui';
import { state, LANGUAGES, PREDEFINED_HABITS, FREQUENCIES, STREAK_SEMI_CONSOLIDATED, STREAK_CONSOLIDATED, saveState } from './state';
import {
    openModal,
    closeModal,
    setupManageModal,
...
export function setupModalListeners() {
    ...
    ui.aiEvalBtn.addEventListener('click', () => {
        const celebration21DayText = _processAndFormatCelebrations(state.pending21DayHabitIds, 'aiCelebration21Day', STREAK_SEMI_CONSOLIDATED || 21);
        const celebration66DayText = _processAndFormatCelebrations(state.pendingConsolidationHabitIds, 'aiCelebration66Day', STREAK_CONSOLIDATED || 66);
