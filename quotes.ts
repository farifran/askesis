...
// A curated list of Stoic quotes from Marcus Aurelius
export const STOIC_QUOTES: Quote[] = [
    ...
    {
        pt: "Você tem poder sobre sua mente – não sobre eventos externos. Perceba isso e encontrará a força.",
    ...
    },
    {
        ...
        es: "No pierdas más tiempo discutiendo sobre lo que un buen hombre debe ser. Sé uno."
    },
    {
        pt: "O melhor revide é ser diferente daquele que comete a injustiça.",
        en: "The best revenge is to be unlike him who performed the injury.",
        es: "La mejor venganza es ser diferente a quien causó la herida."
    },
    {
    ...
    {
        pt: "Se você está angustiado por algo externo, a dor não se deve à coisa em si, mas à sua estimativa dela; e isso você tem o poder de revogar a qualquer momento.",
        ...
        es: "Si estás angustiado por algo externo, el dolor no se debe a la cosa en sí, sino a tu estimación de ella; y esto tienes el poder de revocarlo en cualquier momento."
    },
    {
    ...
    {
        pt: "A perfeição do caráter é isto: viver cada dia como se fosse o último, sem frenesi, sem apatia, sem pretensão.",
        en: "Perfection of character is this: to live each day as if it were your last, without frenzy, without apathy, without pretense.",
        es: "La perfección del carácter es esta: vivir cada día como si fuera el último, sin frenesí, sin apatía, sin pretensión."
    },
    {
    ...
    {
        pt: "Aceite as coisas a que o destino te liga, e ame as pessoas com quem o destino te une, mas faça-o de todo o coração.",
        ...
        es: "Acepta las cosas a las que el destino te ata, y ama a las personas con las que el destino te une, pero hazlo con todo tu corazón."
    },
    {
        pt: "É muito pouco o que é preciso para fazer uma vida feliz; está tudo dentro de você, na sua maneira de pensar.",
        en: "Very little is needed to make a happy life; it is all within yourself, in your way of thinking.",
        es: "Se necesita muy poco para hacer una vida feliz; todo está dentro de ti, en tu forma de pensar."
    },
    {
