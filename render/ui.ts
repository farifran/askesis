...
const ROOT = {
    ...
    syncSection: el<HTMLElement>('#sync-section'),
    ...
    fullCalendarHeader: el<HTMLElement>('#full-calendar-header'),
    ...
    fullCalendarWeekdays: el<HTMLElement>('#full-calendar-weekdays'),
